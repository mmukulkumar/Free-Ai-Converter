...
const Landing: React.FC<LandingProps> = ({ onNavigate }) => {
    return (
        <div className="animate-fade-in pb-20">
            {/* Hero Section */}
            <section className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden text-center bg-white">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 pointer-events-none">
                    {/* Make content clickable via pointer-events-auto */}
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100/80 backdrop-blur-sm border border-slate-200 text-xs font-bold text-slate-600 mb-8 shadow-sm pointer-events-auto">
