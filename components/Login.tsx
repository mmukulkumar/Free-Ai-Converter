...
import { Mail, Lock, ArrowRight, Zap, ArrowLeft, Loader2, AlertCircle } from 'lucide-react';
...
const Login: React.FC<LoginProps> = ({ onLogin, onNavigateSignup, onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-primary-100 blur-[100px] opacity-50"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-blue-100 blur-[100px] opacity-50"></div>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          Or{' '}
          <button onClick={onNavigateSignup} className="font-medium text-primary-600 hover:text-primary-500 transition-colors">
